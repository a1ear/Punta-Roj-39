/**
 * Gallery data for Punta Roj 39.
 * Migrated from gallery.php
 */
...
export const galleryItems = [
  { src: heroCoffee,         alt: 'Latte with delicate foam art',          cat: 'Coffee',   size: 'tall' },
  { src: classicCheeseburger,alt: 'Classic cheeseburger close-up',         cat: 'Burgers',  size: 'wide' },
  { src: padThai,            alt: 'Plated Pad Thai with peanuts and lime', cat: 'Thai',     size: '' },
